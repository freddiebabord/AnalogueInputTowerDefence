...
/////// Vectors:
                ...
                clip(_DiffuseTex_var.a - 0.5);
                float3 lightDirection = normalize(_WorldSpaceLightPos0.xyz);
                float3 lightColor = _LightColor0.rgb;
////// Lighting:
                float attenuation = LIGHT_ATTENUATION(i);
                float3 finalColor = (_DiffuseTex_var.rgb*_DiffuseColour.rgb*(floor(max(0,dot(lightDirection,i.normalDir)) * _ShadeSteps) / (_ShadeSteps - 1)*attenuation*_LightColor0.rgb));
