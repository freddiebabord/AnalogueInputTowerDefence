...
namespace UnityEngine.UI
{
    ...
    [AddComponentMenu("UI/Analogue Toggle", 30)]
    [RequireComponent(typeof(RectTransform))]
    public class AnalogueToggle : AnalogueUIElement, ICanvasElement, IPointerClickHandler, ISubmitHandler
    {
        ...
        [SerializeField]
        private AnalogueToggleGroup m_Group;



        public AnalogueToggleGroup group
        {
            get { return m_Group; }
            set
            {
        ...
        private void SetToggleGroup(AnalogueToggleGroup newGroup, bool setMemberValue)
        {
            AnalogueToggleGroup oldGroup = m_Group;
